...
public class DegoulinuresEffaceur extends GameItem{
	...
	private long previousTime;
		...
		public DegoulinuresEffaceur(float posX,float posY,float width,Context context){
			super(posX,posY);
			this.setPosX(posX);
			this.setPosY(posY);
			this.setWidth(width);
		...
		public void init() {
			...
			float[] vertices = {this.getPosX(),this.getPosY(),0.0f,this.getPosX()+0.3f,this.getPosY(),0.0f,this.getPosX()+0.3f,this.getPosY()+this.getWidth(),0.0f,this.getPosX(),this.getPosY()+this.getWidth(),0.0f};
			...
			float[] textureCoords = {0.5f,this.getWidth()*2,
					0.0f,this.getWidth()*2,
					0.0f,0.0f,
					0.5f,0.0f,
					};
		...
		public void loadTexture() {
		    ...
		    bo.inScaled = false;
		    Bitmap tex = BitmapFactory.decodeResource(this.getContext().getResources(),R.drawable.degoulinures, bo);
