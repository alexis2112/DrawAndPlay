...
public class Effaceur extends GameItem{
	...
	private long previousTime;
		...
		public Effaceur(float posX,float posY,Context context){
			super(posX,posY);
			this.setPosX(posX);
			this.setPosY(posY);
			this.setWidth(0.5f);
		...
		public void loadTexture() {
		    ...
		    bo.inScaled = false;
		    Bitmap tex = BitmapFactory.decodeResource(this.getContext().getResources(),R.drawable.effaceursprite, bo);
