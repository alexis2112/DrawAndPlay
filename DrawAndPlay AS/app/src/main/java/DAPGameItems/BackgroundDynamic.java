...
public class BackgroundDynamic extends GameItem{
	
	public BackgroundDynamic(float posX,float posY,float width,float length,Context context){
		super(posX,posY);
		this.setPosX(posX);
		this.setPosY(posY);
		this.setWidth(width);
	...
	public void init() {
		...
		float[] vertices = {this.getPosX(),this.getPosY(),0.0f,this.getPosX()+this.getLength(),this.getPosY(),0.0f,this.getPosX()+this.getLength(),this.getPosY()+this.getWidth(),0.0f,this.getPosX(),this.getPosY()+this.getWidth(),0.0f};
		...
		float[] textureCoords = {this.getLength()/8,this.getWidth()/4,
				0.0f,this.getWidth()/4,
				0.0f,0.0f,
				this.getLength()/8,0.0f,
				};
	...
	public void loadTexture() {
	    ...
	    bo.inScaled = false;
	    Bitmap tex = BitmapFactory.decodeResource(this.getContext().getResources(),R.drawable.dynamicbackground, bo);
