...
public class Background extends GameItem{
	...
	public Background(float posX,float posY,float length,float width,Context context){
		super(posX,posY);
		this.setPosX(posX);
		this.setPosY(posY);
		this.setWidth(width);
	...
	public void init() {
		...
		float[] vertices = {this.getPosX(),this.getPosY(),-1.0f,this.getPosX()+this.getLength(),this.getPosY(),-1.0f,this.getPosX()+this.getLength(),this.getPosY()+getWidth(),-1.0f,this.getPosX(),this.getPosY()+getWidth(),-1.0f};
	...
	public void loadTexture() {
	    ...
	    bo.inScaled = false;
	    Bitmap tex = BitmapFactory.decodeResource(this.getContext().getResources(),R.drawable.background, bo);
	...
	public void updateCoordinates(){
		this.translation=this.getRenderer().getEyePos();
		}
