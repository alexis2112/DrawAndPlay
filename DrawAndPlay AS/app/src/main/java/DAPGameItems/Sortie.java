...
public class Sortie extends GameItem{
	public Sortie(float posX,float posY,Context context){
		super(posX,posY);
		this.setPosX(posX);
		this.setPosY(posY);
		this.setWidth(1.5f);
	...
	public void init() {
		...
		float[] vertices = {this.getPosX(),this.getPosY(),0.0f,this.getPosX()+1.5f,this.getPosY(),0.0f,this.getPosX()+1.5f,this.getPosY()+1.5f,0.0f,this.getPosX(),this.getPosY()+1.5f,0.0f};
	...
	public void loadTexture() {
	    ...
	    bo.inScaled = false;
	    Bitmap tex = BitmapFactory.decodeResource(this.getContext().getResources(),R.drawable.sortie, bo);
